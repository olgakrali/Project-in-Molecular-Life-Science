...
# Define my lists outside the function
protein_ID, sequences, topology = my_par("subset_10_proteins.txt")


# The my_one_hot_enc functions returns a dictionary with binaries for every amino acide
def my_one_hot_enc():
    ...
    for line, aa in zip(zero_one, aminoacid):  ### it reads simultaneously every row and every amino acid
        dictionary[aa] = line
    return dictionary, aminoacid

# Define my dictionary and amino acid list outside of the function
dictionary, aminoacid = my_one_hot_enc()

# This function returns sliding windows for every sequence

def my_windows(slide_window_size):
...
# This function returns the three states of my dataset in a list of integers
def my_labels():
