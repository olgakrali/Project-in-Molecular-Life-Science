...
my_names, new_seq, new_top, struct_labels, X_test, y_test =  ps.my_par(path3 + "test_final.txt", fnames, 13, path2)
...
plt.title('Confusion Matrix for the 89 predicted sequences PSSM (window = 13)')
...
with open(path3 + 'true_vs_predicted_topo_RFC_PSSM_final.txt', 'w') as file:
