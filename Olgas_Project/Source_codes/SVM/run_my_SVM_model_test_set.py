...
# Load the model
my_model = joblib.load(path2 + "my_test.sav")
...
plt.title('Confusion Matrix for the predicted sequences (window = 19)')
...
with open(path + 'true_vs_predicted_topo.txt', 'w') as file:
